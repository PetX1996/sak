...
//			}
	...
	else
	{
			...
			*/
			...
			//zaklad 5, premenna idamage upravena podla aktualne classu utocnika...
			//
			//Class 1(Armored) = 30dmg
			//Class 2(Fast) = 35dmg
			//Class 3(poison) = 30+40dmg
			//Class 4() = 40dmg
			//Class 5() = 45dmg
			//special class() = 50dmg
			//
			*/
			...
			if (isdefined(eAttacker) && eAttacker.pers["team"] == "axis") //team = lovec
			{
				switch(eAttacker.class_damage)	
				{
				case "class1_lovec":
					iDamage = 30; 
					break;
	...
	if (isplayer(self)&&isplayer(eAttacker)&&isAlive(eAttacker)&&isAlive(self)&&eAttacker.pers["team"] != self.pers["team"])
	{
...
smoke_poison()
{
	...
	while(1)
	{
		playFx(level._effect[ "smoke_poison" ], self.origin+(0, 0, 50));
		wait 0.3;
	}
}	
		...
		else
		{
			...
			else
			{
				...
				else
				{
					...
					attacker thread petx\_upoint::GiveuPoint( "kill" );  /////////////////////////////////////////////////////////////////////////////////pridanie  Upoint ////////////////////////////////////////////////
				}
